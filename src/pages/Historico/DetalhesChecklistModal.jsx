...
                {/* NOVO CABEÇALHO (Passo 1) */}
                <div className={styles.modalHeader}>
                  <div className={styles.modalIcon}>
                    <i className="fas fa-clipboard-check"></i>
                  </div>
                  <div>
                    <h2>Checklist #{selectedChecklist.documento_id}</h2>
                    <p className={styles.modalSubtitle}>
                      Detalhes completos do registro de produção e assistência
                    </p>
                  </div>
                </div>
                
...
                </div>
                
                {/* NOVO BOTÃO DE FECHAR (Passo 1) */}
                <button className={styles.btnCloseModal} onClick={onClose}>
                  <i className="fas fa-times-circle"></i> Fechar Detalhes
                </button>
            </div>
        </div>
    );
